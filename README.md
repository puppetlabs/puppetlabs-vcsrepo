...
Features: `bare_repositories`, `depth`, `multiple_remotes`, `reference_tracking`, `repository_status', `ssh_identity`, `submodules`, `user`
...
* `repository_status` - Can enforce the status of a working copy. (Available with `git`.)
